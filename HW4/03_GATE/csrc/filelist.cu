...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _3790_archive_1.so
_3790_archive_1.so : archive.78/_3790_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_3790_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_3790_archive_1.so $@
...
VCS_CU_ARC_OBJS0 =objs/a/amcQw_d.o 
