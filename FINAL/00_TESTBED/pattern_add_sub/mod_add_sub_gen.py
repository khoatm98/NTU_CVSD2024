...
if __name__ == "__main__":
    ...
    print(("x: {:064x}\n".format( ( (0x1f9efb878ebd7f10da27cd282e1e2aa005b41608c540dc3e202ecf74aefe12a2) +(0x008024cc1748e6993922f49fb61e2c2d3b5164c7fe39c8e54e0ec8c7a34d942a) ) % q )))
    
    GEN_NUM = 10000
    f1 = open("add_sub_I.dat", "w")
    f2 = open("add_sub_O.dat", "w")
    counter = 0;
    while( counter < GEN_NUM):
        ...
        f1List.append(str(mod))
        f1List.append(str(f"{a:0{255}b}"))
        f1List.append(str(f"{b:0{255}b}"))

        f1String = ''.join(f1List)
        ...
        if (mod == 0):
            ...
            out = (a+b)%q
        f2List.append(str(f"{out:0{255}b}"))
        f2String = ''.join(f2List)
