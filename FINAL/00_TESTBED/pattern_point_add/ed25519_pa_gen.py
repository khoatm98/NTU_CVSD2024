...
if __name__ == "__main__":
    ...
    f_x1 = open("pa_x1_I.dat", "w")
    f_y1 = open("pa_y1_I.dat", "w")
    f_x2 = open("pa_x2_I.dat", "w")
    f_y2 = open("pa_y2_I.dat", "w")
    f_z2 = open("pa_z2_I.dat", "w")
    
    f_x3 = open("pa_x3_O.dat", "w")
    f_y3 = open("pa_y3_O.dat", "w")
    f_z3 = open("pa_z3_O.dat", "w")
    ...
    while( counter < GEN_NUM):
        ...
        dd = random.randint(0, 2**255 - 19)
        e = random.randint(0, 2**255 - 19)
        
        fl_x2.append(str(f"{c:0{255}b}"))
        fl_y2.append(str(f"{dd:0{255}b}"))
        fl_z2.append(str(f"{e:0{255}b}"))
        ...
        #point  = point(number(c), number(d))
        pointA = point(number(a), number(b))
        pointB = point(number(c), number(dd), number(e))
        #print("pointA")
        #print(pointA)
        #print("pointB")
        #print(pointB)
        ...
        #print("pointC")
        #print(pointC)
        fl_x3.append(str(f"{pointC.X.value:0{255}b}"))
        fl_y3.append(str(f"{pointC.Y.value:0{255}b}"))
        fl_z3.append(str(f"{pointC.Z.value:0{255}b}"))
        
        fx3String = ''.join(fl_x3)
        fy3String = ''.join(fl_y3)
        fz3String = ''.join(fl_z3)
        
        f_x3.write(fx3String)
        f_y3.write(fy3String)
        f_z3.write(fz3String)
        f_x3.write('\n')
        f_y3.write('\n')
        f_z3.write('\n')
        counter = counter + 1
