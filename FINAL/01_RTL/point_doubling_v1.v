...
reg	  valid_r, i_first_lvl2_r, i_first_lvl_r, i_first_lvl_r1;
reg [5:0] lvl_count;
reg [3:0] pd_level;
reg [255:0] A_r, B_r, C_r, D_r, E_r, F_r, J_r;
	...
	if (i_rst) begin
		...
		case (pd_level) 
			...
			4: begin
				...
				if (i_first_lvl) begin
					lvl4_res_addsub <= res_addsub_w0; //temporary save add in level 4
                        	end
			end 
                        5: begin
