...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _12000_archive_1.so
_12000_archive_1.so : archive.32/_12000_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_12000_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_12000_archive_1.so $@
