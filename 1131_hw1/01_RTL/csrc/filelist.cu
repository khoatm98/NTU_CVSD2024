...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _257657_archive_1.so
_257657_archive_1.so : archive.229/_257657_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_257657_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_257657_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.229/_prev_archive_1.a
	@$(AR) -s $<
