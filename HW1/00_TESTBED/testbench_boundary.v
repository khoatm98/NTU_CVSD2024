...
`elsif I9
    ...
    `define PAT_LEN 40
`elsif I10
    `define IDATA  "../00_TESTBED/INST_10W_MIX_I.dat"
    `define ODATA  "../00_TESTBED/INST_10W_MIX_O.dat"
    `define PAT_LEN 10000
`elsif I11
    `define IDATA  "../00_TESTBED/INST_10W_ACC_I.dat"
    `define ODATA  "../00_TESTBED/INST_10W_ACC_O.dat"
    `define PAT_LEN 10000
`elsif I12
    `define IDATA  "../00_TESTBED/INST10W_clz_I.dat"
    `define ODATA  "../00_TESTBED/INST10W_clz_O.dat"
    `define PAT_LEN 10000
`elsif I13
    `define IDATA  "../00_TESTBED/INST10W_sp_I.dat"
    `define ODATA  "../00_TESTBED/INST10W_sp_O.dat"
    `define PAT_LEN 10000
`elsif I14
    `define IDATA  "../00_TESTBED/INST_10W_xor_I.dat"
    `define ODATA  "../00_TESTBED/INST_10W_xor_O.dat"
    `define PAT_LEN 10000
`elsif I15
    `define IDATA  "../00_TESTBED/INST_10W_ars_I.dat"
    `define ODATA  "../00_TESTBED/INST_10W_ars_O.dat"
    `define PAT_LEN 10000
`elsif I16
    `define IDATA  "../00_TESTBED/INST_10W_crl_I.dat"
    `define ODATA  "../00_TESTBED/INST_10W_crl_O.dat"
    `define PAT_LEN 10000
`else
    `define IDATA  "../00_TESTBED/pattern/INST0_I.dat"
    `define ODATA  "../00_TESTBED/pattern/INST0_O.dat"
